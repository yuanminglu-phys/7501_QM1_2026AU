...
\end{align}
In other words, Hamiltonian $\hat H$ is a block diagnoal matrix in the eigenbasis of the conserved quantity $\hat O$. This is known as the selection rule in quantum mechanics. 
