...
\begin{align}
    G(x,x^\prime;t)=-\imth\sum_n\psi_n(x)\psi^\ast_n(x^\prime)e^{-\imth E_nt/\hbar}
\end{align}
where $E_n$ and $\psi_n(x)$ are the eigenvalues and eigenstates of Hamiltonian $\hat H$. 

(3) \textbf{Bonus} Show that the imaginary part of the frequency-space propagator is given by
\begin{align}
