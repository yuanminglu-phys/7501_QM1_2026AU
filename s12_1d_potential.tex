...
\begin{equation}
 \imth k(t-1+r)=\frac{2mV_0}{\hbar^2}t.
\end{equation}
Define
\begin{equation}
 \alpha=\frac{mV_0}{\hbar^2k}.
\end{equation}
Then
\begin{equation}
...
Equivalently,
\begin{equation}
 t=\frac{1}{1-mV_0/(\imth k\hbar^2)},
 \qquad
 r=\frac{mV_0/(\imth k\hbar^2)}{1-mV_0/(\imth k\hbar^2)}.
\end{equation}
The fluxes satisfy
\begin{equation}
 |t|^2+|r|^2=1.
\end{equation}
The same scattering result applies to either sign of $V_0$ as long as
$E>0$.

\textbf{Bound state for an attractive delta potential}

Let $V_0<0$ and $E<0$. Define
\begin{equation}
...
\begin{equation}
 -2\kappa A=\frac{2mV_0}{\hbar^2}A,
\end{equation}
so
\begin{equation}
 \kappa=-\frac{mV_0}{\hbar^2}=\frac{m|V_0|}{\hbar^2}.
\end{equation}
