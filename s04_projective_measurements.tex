...
\referto{\nielsen~2.2.4-2.2.7, \tong~3.4, 4.2, 16.4.1}
...
\begin{align}
\expval{\hat M}\equiv\expval{\psi|\hat M|\psi}=\sum_m m\times \text{Pr}(m)
\end{align}
