...
\end{align}
which measures the probability that an initial state $\dket{i}$ evolves into a final state $\dket{f}$ after time $t$. This quantity is related to the outgoing beam intensity in scattering experiments.
