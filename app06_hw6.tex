...
(1) Write down the form of an $E<0$ bound state wavefunction in the three regions:
...
(2) Write down the matching conditions at $x=\pm x_0$, to continuously connect the wavefunctions of the 3 regions. 
